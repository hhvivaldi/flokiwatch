...
_REX_TOOLS = [
    ...
    {"type": "function", "function": {"name": "get_candles", "description": "Get OHLCV candles for any supported timeframe. M5/M15 for entry timing and micro-structure, H1 for the working frame, H4 for intraday trend, D1 for macro structure. Max 15 candles (H1 bumps to 50 for swing visibility).", "parameters": {"type": "object", "properties": {"timeframe": {"type": "string", "enum": ["M5", "M15", "H1", "H4", "D1"]}, "count": {"type": "integer"}}, "required": ["timeframe"], "additionalProperties": False}}},
