...
# ============================================================================
USE_EA_BRIDGE = False                     # True = EA handles execution, False = direct MT5 API (DISABLED until full integration testing)
EA_STALE_THRESHOLD_SECONDS = 60           # If ea_status.json older than this, fall back to direct API
