...
DISCORD_WEBHOOK_DATA_NEEDS = os.environ.get("DISCORD_WEBHOOK_DATA_NEEDS", "")  # FLO-302: Floki's data_needs feed
...
CHART_H4_PNG_PATH = os.environ.get("CHART_H4_PNG_PATH", os.path.join(_MQL5_FILES, "chart_h4.png"))
...
AI_AGENT_TIMEOUT = int(os.environ.get("AI_AGENT_TIMEOUT", "300"))  # Timeout in seconds for API calls (env-overridable; 600+ recommended under LLM_PROVIDER=agent_sdk per FLO-426)
