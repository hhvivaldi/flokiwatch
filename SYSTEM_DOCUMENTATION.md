...
- **Rex Monitor (Python, deterministic, FLO-434 reduced)**: deterministic background scanner que corre a cada 30 min independentemente. Surfaces divergence / correlation / regime / session findings. Floki pulls via `get_rex_monitor`. **REMOVIDO FLO-434 (2026-05-17):** o Bull/Bear debate conversacional (rex_validator) e o Research Manager foram removidos do ciclo — modelos mais fracos que Floki (Claude Opus 4.6) produziam ruído. Floki é único decisor.
...
**31 ferramentas disponíveis (5 categorias: Technical, Cross-market, Macro, Performance, Reflexão):**
...
- Reflexão: get_recent_reflexions, search_reflexions, search_memory (FLO-137/138)
